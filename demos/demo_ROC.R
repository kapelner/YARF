...
res = YARFROC(Pima.tr[, 1 : 7], Pima.tr$type, desired_interval = 0.1, y_axis_fine_resolution = TRUE)

calcAUC(res)

res = YARFROC(Pima.tr[, 1 : 7], Pima.tr$type, x_axis = "fnr", y_axis = "fdr")
res = YARFROC(Pima.tr[, 1 : 7], Pima.tr$type, x_axis = "fomr", y_axis = "tpr", y_axis_fine_resolution = TRUE)
