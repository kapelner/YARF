...
#' @param background_rgb_color 			A vector with 3 elements in \code{0, 1, ..., 255} specifying the RGB color
#' 										of the background. Default is \code{c(255, 255, 255)} for white.
#' @param line_rgb_color 				A vector with 3 elements in \code{0, 1, ..., 255} specifying the RGB color
#' 										of the lines. Default is \code{c(100, 100, 100)} for grey.
#' @param text_rgb_color				A vector with 3 elements in \code{0, 1, ..., 255} specifying the RGB color
