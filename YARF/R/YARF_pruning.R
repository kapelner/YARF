...
#' @param prune_if_script	A custom javascript function which determines the pruning og a node (i.e. deletes the node's children and
#' 							sets the node to a leaf and sets a y_hat using the assign function).
